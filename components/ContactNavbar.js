...
const ContactNavbar = () => {
  return (
    <div className="flex justify-between items-center p-4 bg-panel-header-background h-[60px]">
      <div className="relative w-[35px] h-[35px] rounded-full overflow-hidden">
        <Image
          src={
            'https://pps.whatsapp.net/v/t61.24694-24/56702511_281546792777408_7480391488283607040_n.jpg?stp=dst-jpg_s96x96&ccb=11-4&oh=01_AVyxcmtBXzF_7au8drKIL_koEsSJLEkg4dibEveEHQtzyg&oe=630A9438'
          }
          alt="Profile pic"
          width={30}
          height={30}
      ...
      <ul className="flex justify-center align-center gap-6 px-3">
        <li className="cursor-pointer rounded-ful">
          {/* <FontAwesomeIcon icon={faInfo} className="text-[22px]" /> */}
          <svg
            version="1.1"
